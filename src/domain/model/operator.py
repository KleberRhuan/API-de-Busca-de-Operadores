...
from sqlalchemy import SMALLINT, Column, Date, Integer, String
...
class Operator(Base):
    ...
    operator_registry: str = Column(
        "registro_operadora", String, key="operatorRegistry"
    )
    ...
    representative_position: str = Column(
        "cargo_representante", String, key="representativePosition"
    )
    sales_region: SMALLINT = Column(
        "regiao_de_comercializacao", SMALLINT, key="salesRegion"
    )
